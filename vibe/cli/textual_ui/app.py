...
class VibeApp(App):  # noqa: PLR0904
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        # Prompt enhancement mode tracking
        self._enhancement_mode = False
        self._original_prompt_for_enhancement: str = ""
        ...
        self._current_mode_safety = ModeSafety.NEUTRAL
            ...
            if init_task and not init_task.done():
                ...
                try:
                    ...
                    if self._loading_widget and self._loading_widget.parent:
                        ...
                        self._loading_widget = None
                    if pending_init:
                        # TODO: Is this pending state of user message really needed? When does it become True?
    ...
    async def _switch_to_input_app(self) -> None:
        ...
        try:
            ...
            if chat_input_container is None:
                ...
                await self.mount(chat_input_container)
    ...
    def _focus_current_bottom_app(self) -> None:
        try:
            match self._current_bottom_app:
                ...
                case BottomApp.Session:
                    # Session app doesn't need focus, it's just a state
                    pass
                case app:
                    assert_never(app)
        except Exception:
