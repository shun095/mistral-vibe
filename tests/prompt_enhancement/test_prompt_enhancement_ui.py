...
async def test_enhancement_can_be_cancelled_with_escape_key(vibe_app: VibeApp):
    ...
    async with vibe_app.run_test() as pilot:
        ...
        assert vibe_app._enhancement_task is not None, (
            "Enhancement task should be created"
        )
        assert not vibe_app._enhancement_task.done(), (
            "Enhancement task should not be done"
        )
...
async def test_enhancement_replaces_prompt(vibe_app: VibeApp):
    ...
    FakeBackend([mock_llm_chunk(content="Enhanced: Write a Python function")])
...
async def test_enhancement_with_special_characters(vibe_app: VibeApp):
    ...
    FakeBackend([mock_llm_chunk(content="Enhanced: /search files")])
